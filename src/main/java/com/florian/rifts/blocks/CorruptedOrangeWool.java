...
public class CorruptedOrangeWool extends AbstractCorruptedBlock {
    public CorruptedOrangeWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_WOOL);
    }
}
