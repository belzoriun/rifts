...
public class CorruptedGoldBlock extends AbstractCorruptedBlock {
    public CorruptedGoldBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GOLD_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GOLD_BLOCK);
    }
}
