...
public class CorruptedBeeNest extends AbstractCorruptedBlock {
    public CorruptedBeeNest() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BEE_NEST;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BEE_NEST);
    }
}
