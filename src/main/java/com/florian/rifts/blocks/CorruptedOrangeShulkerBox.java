...
public class CorruptedOrangeShulkerBox extends AbstractCorruptedBlock {
    public CorruptedOrangeShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_SHULKER_BOX);
    }
}
