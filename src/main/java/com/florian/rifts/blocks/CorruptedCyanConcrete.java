...
public class CorruptedCyanConcrete extends AbstractCorruptedBlock {
    public CorruptedCyanConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_CONCRETE);
    }
}
