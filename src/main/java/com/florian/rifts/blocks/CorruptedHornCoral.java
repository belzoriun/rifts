...
public class CorruptedHornCoral extends AbstractCorruptedBlock {
    public CorruptedHornCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HORN_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HORN_CORAL);
    }
}
