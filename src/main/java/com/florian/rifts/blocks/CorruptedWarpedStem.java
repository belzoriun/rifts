...
public class CorruptedWarpedStem extends AbstractCorruptedBlock {
    public CorruptedWarpedStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_STEM);
    }
}
