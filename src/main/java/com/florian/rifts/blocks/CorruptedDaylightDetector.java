...
public class CorruptedDaylightDetector extends AbstractCorruptedBlock {
    public CorruptedDaylightDetector() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DAYLIGHT_DETECTOR;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DAYLIGHT_DETECTOR);
    }
}
