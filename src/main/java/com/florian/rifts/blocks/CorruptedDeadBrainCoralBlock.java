...
public class CorruptedDeadBrainCoralBlock extends AbstractCorruptedBlock {
    public CorruptedDeadBrainCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_BRAIN_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_BRAIN_CORAL_BLOCK);
    }
}
