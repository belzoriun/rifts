...
public class CorruptedKelpPlant extends AbstractCorruptedBlock {
    public CorruptedKelpPlant() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_KELP_PLANT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(KELP_PLANT);
    }
}
