...
public class CorruptedBeehive extends AbstractCorruptedBlock {
    public CorruptedBeehive() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BEEHIVE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BEEHIVE);
    }
}
