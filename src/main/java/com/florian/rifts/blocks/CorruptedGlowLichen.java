...
public class CorruptedGlowLichen extends AbstractCorruptedBlock {
    public CorruptedGlowLichen() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GLOW_LICHEN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GLOW_LICHEN);
    }
}
