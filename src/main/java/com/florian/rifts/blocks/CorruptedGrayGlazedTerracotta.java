...
public class CorruptedGrayGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedGrayGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_GLAZED_TERRACOTTA);
    }
}
