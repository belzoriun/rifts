...
public class CorruptedLilyOfTheValley extends AbstractCorruptedBlock {
    public CorruptedLilyOfTheValley() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LILY_OF_THE_VALLEY;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LILY_OF_THE_VALLEY);
    }
}
