...
public class CorruptedMossBlock extends AbstractCorruptedBlock {
    public CorruptedMossBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MOSS_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MOSS_BLOCK);
    }
}
