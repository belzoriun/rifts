...
public class CorruptedAzalea extends AbstractCorruptedBlock {
    public CorruptedAzalea() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_AZALEA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(AZALEA);
    }
}
