...
public class CorruptedStructureBlock extends AbstractCorruptedBlock {
    public CorruptedStructureBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRUCTURE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRUCTURE_BLOCK);
    }
}
