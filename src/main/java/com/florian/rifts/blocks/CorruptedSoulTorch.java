...
public class CorruptedSoulTorch extends AbstractCorruptedBlock {
    public CorruptedSoulTorch() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SOUL_TORCH;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SOUL_TORCH);
    }
}
