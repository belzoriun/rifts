...
public class CorruptedLightGrayShulkerBox extends AbstractCorruptedBlock {
    public CorruptedLightGrayShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_GRAY_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_GRAY_SHULKER_BOX);
    }
}
