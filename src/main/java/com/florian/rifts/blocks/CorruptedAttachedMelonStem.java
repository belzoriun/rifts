...
public class CorruptedAttachedMelonStem extends AbstractCorruptedBlock {
    public CorruptedAttachedMelonStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ATTACHED_MELON_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ATTACHED_MELON_STEM);
    }
}
