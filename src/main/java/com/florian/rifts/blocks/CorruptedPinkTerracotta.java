...
public class CorruptedPinkTerracotta extends AbstractCorruptedBlock {
    public CorruptedPinkTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_TERRACOTTA);
    }
}
