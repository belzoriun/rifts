...
public class CorruptedPinkStainedGlass extends AbstractCorruptedBlock {
    public CorruptedPinkStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_STAINED_GLASS);
    }
}
