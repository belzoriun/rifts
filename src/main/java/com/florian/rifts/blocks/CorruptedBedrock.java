...
public class CorruptedBedrock extends AbstractCorruptedBlock {
    public CorruptedBedrock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BEDROCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BEDROCK);
    }
}
