...
public class CorruptedSandstone extends AbstractCorruptedBlock {
    public CorruptedSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SANDSTONE);
    }
}
