...
public class CorruptedRedstoneBlock extends AbstractCorruptedBlock {
    public CorruptedRedstoneBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_REDSTONE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(REDSTONE_BLOCK);
    }
}
