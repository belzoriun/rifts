...
public class CorruptedCopperBlock extends AbstractCorruptedBlock {
    public CorruptedCopperBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COPPER_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COPPER_BLOCK);
    }
}
