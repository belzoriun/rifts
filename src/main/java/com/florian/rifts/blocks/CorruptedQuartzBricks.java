...
public class CorruptedQuartzBricks extends AbstractCorruptedBlock {
    public CorruptedQuartzBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_QUARTZ_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(QUARTZ_BRICKS);
    }
}
