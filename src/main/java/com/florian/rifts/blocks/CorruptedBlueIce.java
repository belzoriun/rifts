...
public class CorruptedBlueIce extends AbstractCorruptedBlock {
    public CorruptedBlueIce() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_ICE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_ICE);
    }
}
