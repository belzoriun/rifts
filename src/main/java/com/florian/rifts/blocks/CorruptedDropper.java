...
public class CorruptedDropper extends AbstractCorruptedBlock {
    public CorruptedDropper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DROPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DROPPER);
    }
}
