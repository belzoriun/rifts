...
public class CorruptedDeadFireCoralFan extends AbstractCorruptedBlock {
    public CorruptedDeadFireCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_FIRE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_FIRE_CORAL_FAN);
    }
}
