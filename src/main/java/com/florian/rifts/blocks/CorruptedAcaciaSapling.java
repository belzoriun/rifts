...
public class CorruptedAcaciaSapling extends AbstractCorruptedBlock {
    public CorruptedAcaciaSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ACACIA_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ACACIA_SAPLING);
    }
}
