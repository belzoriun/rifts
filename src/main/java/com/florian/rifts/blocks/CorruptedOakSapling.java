...
public class CorruptedOakSapling extends AbstractCorruptedBlock {
    public CorruptedOakSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OAK_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OAK_SAPLING);
    }
}
