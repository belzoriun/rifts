...
public class CorruptedBlackConcretePowder extends AbstractCorruptedBlock {
    public CorruptedBlackConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_CONCRETE_POWDER);
    }
}
