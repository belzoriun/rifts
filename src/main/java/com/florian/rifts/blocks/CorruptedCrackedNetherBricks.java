...
public class CorruptedCrackedNetherBricks extends AbstractCorruptedBlock {
    public CorruptedCrackedNetherBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRACKED_NETHER_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRACKED_NETHER_BRICKS);
    }
}
