...
public class CorruptedEndPortalFrame extends AbstractCorruptedBlock {
    public CorruptedEndPortalFrame() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_END_PORTAL_FRAME;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(END_PORTAL_FRAME);
    }
}
