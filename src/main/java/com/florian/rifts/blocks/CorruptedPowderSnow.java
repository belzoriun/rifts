...
public class CorruptedPowderSnow extends AbstractCorruptedBlock {
    public CorruptedPowderSnow() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POWDER_SNOW;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POWDER_SNOW);
    }
}
