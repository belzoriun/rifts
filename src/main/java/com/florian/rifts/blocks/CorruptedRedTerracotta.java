...
public class CorruptedRedTerracotta extends AbstractCorruptedBlock {
    public CorruptedRedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_TERRACOTTA);
    }
}
