...
public class CorruptedTintedGlass extends AbstractCorruptedBlock {
    public CorruptedTintedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TINTED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TINTED_GLASS);
    }
}
