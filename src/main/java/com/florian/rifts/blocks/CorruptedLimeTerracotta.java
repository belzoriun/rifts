...
public class CorruptedLimeTerracotta extends AbstractCorruptedBlock {
    public CorruptedLimeTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_TERRACOTTA);
    }
}
