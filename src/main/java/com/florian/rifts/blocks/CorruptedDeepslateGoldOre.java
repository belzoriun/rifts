...
public class CorruptedDeepslateGoldOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateGoldOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_GOLD_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_GOLD_ORE);
    }
}
