...
public class CorruptedDeepslateEmeraldOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateEmeraldOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_EMERALD_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_EMERALD_ORE);
    }
}
