...
public class CorruptedBlackWool extends AbstractCorruptedBlock {
    public CorruptedBlackWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_WOOL);
    }
}
