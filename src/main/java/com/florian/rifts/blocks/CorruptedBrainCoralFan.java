...
public class CorruptedBrainCoralFan extends AbstractCorruptedBlock {
    public CorruptedBrainCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BRAIN_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BRAIN_CORAL_FAN);
    }
}
