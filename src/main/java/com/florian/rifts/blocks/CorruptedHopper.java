...
public class CorruptedHopper extends AbstractCorruptedBlock {
    public CorruptedHopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HOPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HOPPER);
    }
}
