...
public class CorruptedMagentaShulkerBox extends AbstractCorruptedBlock {
    public CorruptedMagentaShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MAGENTA_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MAGENTA_SHULKER_BOX);
    }
}
