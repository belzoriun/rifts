...
public class CorruptedDiamondOre extends AbstractCorruptedBlock {
    public CorruptedDiamondOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DIAMOND_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DIAMOND_ORE);
    }
}
