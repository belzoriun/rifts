...
public class CorruptedLightBlueConcrete extends AbstractCorruptedBlock {
    public CorruptedLightBlueConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_BLUE_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_BLUE_CONCRETE);
    }
}
