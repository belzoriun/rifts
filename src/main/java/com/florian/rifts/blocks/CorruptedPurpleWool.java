...
public class CorruptedPurpleWool extends AbstractCorruptedBlock {
    public CorruptedPurpleWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_WOOL);
    }
}
