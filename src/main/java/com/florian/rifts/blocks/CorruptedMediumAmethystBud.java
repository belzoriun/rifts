...
public class CorruptedMediumAmethystBud extends AbstractCorruptedBlock {
    public CorruptedMediumAmethystBud() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MEDIUM_AMETHYST_BUD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MEDIUM_AMETHYST_BUD);
    }
}
