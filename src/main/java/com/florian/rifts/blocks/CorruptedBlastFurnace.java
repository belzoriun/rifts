...
public class CorruptedBlastFurnace extends AbstractCorruptedBlock {
    public CorruptedBlastFurnace() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLAST_FURNACE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLAST_FURNACE);
    }
}
