...
public class CorruptedWeepingVines extends AbstractCorruptedBlock {
    public CorruptedWeepingVines() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WEEPING_VINES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WEEPING_VINES);
    }
}
