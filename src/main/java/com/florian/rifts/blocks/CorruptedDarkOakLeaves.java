...
public class CorruptedDarkOakLeaves extends AbstractCorruptedBlock {
    public CorruptedDarkOakLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DARK_OAK_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DARK_OAK_LEAVES);
    }
}
