...
public class CorruptedRedNetherBricks extends AbstractCorruptedBlock {
    public CorruptedRedNetherBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_NETHER_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_NETHER_BRICKS);
    }
}
