...
public class CorruptedCutSandstone extends AbstractCorruptedBlock {
    public CorruptedCutSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CUT_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CUT_SANDSTONE);
    }
}
