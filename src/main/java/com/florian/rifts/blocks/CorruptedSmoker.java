...
public class CorruptedSmoker extends AbstractCorruptedBlock {
    public CorruptedSmoker() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMOKER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMOKER);
    }
}
