...
public class CorruptedYellowWool extends AbstractCorruptedBlock {
    public CorruptedYellowWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_YELLOW_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(YELLOW_WOOL);
    }
}
