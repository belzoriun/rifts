...
public class CorruptedDeepslateRedstoneOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateRedstoneOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_REDSTONE_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_REDSTONE_ORE);
    }
}
