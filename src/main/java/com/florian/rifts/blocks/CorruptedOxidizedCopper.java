...
public class CorruptedOxidizedCopper extends AbstractCorruptedBlock {
    public CorruptedOxidizedCopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OXIDIZED_COPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OXIDIZED_COPPER);
    }
}
