...
public class CorruptedTripwireHook extends AbstractCorruptedBlock {
    public CorruptedTripwireHook() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TRIPWIRE_HOOK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TRIPWIRE_HOOK);
    }
}
