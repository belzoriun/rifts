...
public class CorruptedRedstoneOre extends AbstractCorruptedBlock {
    public CorruptedRedstoneOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_REDSTONE_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(REDSTONE_ORE);
    }
}
