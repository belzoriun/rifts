...
public class CorruptedWhiteStainedGlass extends AbstractCorruptedBlock {
    public CorruptedWhiteStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_STAINED_GLASS);
    }
}
