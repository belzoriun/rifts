...
public class CorruptedCoalOre extends AbstractCorruptedBlock {
    public CorruptedCoalOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COAL_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COAL_ORE);
    }
}
