...
public class CorruptedPinkConcretePowder extends AbstractCorruptedBlock {
    public CorruptedPinkConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_CONCRETE_POWDER);
    }
}
