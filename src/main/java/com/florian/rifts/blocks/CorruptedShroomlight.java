...
public class CorruptedShroomlight extends AbstractCorruptedBlock {
    public CorruptedShroomlight() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SHROOMLIGHT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SHROOMLIGHT);
    }
}
