...
public class CorruptedExposedCutCopper extends AbstractCorruptedBlock {
    public CorruptedExposedCutCopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_EXPOSED_CUT_COPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(EXPOSED_CUT_COPPER);
    }
}
