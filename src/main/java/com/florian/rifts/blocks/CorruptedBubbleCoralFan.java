...
public class CorruptedBubbleCoralFan extends AbstractCorruptedBlock {
    public CorruptedBubbleCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BUBBLE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BUBBLE_CORAL_FAN);
    }
}
