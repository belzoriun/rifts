...
public class CorruptedDirtPath extends AbstractCorruptedBlock {
    public CorruptedDirtPath() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DIRT_PATH;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DIRT_PATH);
    }
}
