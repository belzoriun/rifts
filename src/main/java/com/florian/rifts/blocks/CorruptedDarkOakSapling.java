...
public class CorruptedDarkOakSapling extends AbstractCorruptedBlock {
    public CorruptedDarkOakSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DARK_OAK_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DARK_OAK_SAPLING);
    }
}
