...
public class CorruptedStrippedBirchLog extends AbstractCorruptedBlock {
    public CorruptedStrippedBirchLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_BIRCH_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_BIRCH_LOG);
    }
}
