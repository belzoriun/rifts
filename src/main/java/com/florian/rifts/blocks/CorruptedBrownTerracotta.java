...
public class CorruptedBrownTerracotta extends AbstractCorruptedBlock {
    public CorruptedBrownTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_TERRACOTTA);
    }
}
