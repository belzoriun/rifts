...
public class CorruptedDragonEgg extends AbstractCorruptedBlock {
    public CorruptedDragonEgg() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DRAGON_EGG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DRAGON_EGG);
    }
}
