...
public class CorruptedJackOLantern extends AbstractCorruptedBlock {
    public CorruptedJackOLantern() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JACK_O_LANTERN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JACK_O_LANTERN);
    }
}
