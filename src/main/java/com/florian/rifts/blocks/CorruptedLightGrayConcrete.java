...
public class CorruptedLightGrayConcrete extends AbstractCorruptedBlock {
    public CorruptedLightGrayConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_GRAY_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_GRAY_CONCRETE);
    }
}
