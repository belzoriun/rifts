...
public class CorruptedDeadHornCoral extends AbstractCorruptedBlock {
    public CorruptedDeadHornCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_HORN_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_HORN_CORAL);
    }
}
