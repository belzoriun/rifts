...
public class CorruptedGrindstone extends AbstractCorruptedBlock {
    public CorruptedGrindstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRINDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRINDSTONE);
    }
}
