...
public class CorruptedBlueWool extends AbstractCorruptedBlock {
    public CorruptedBlueWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_WOOL);
    }
}
