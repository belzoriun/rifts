...
public class CorruptedSprucePlanks extends AbstractCorruptedBlock {
    public CorruptedSprucePlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPRUCE_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPRUCE_PLANKS);
    }
}
