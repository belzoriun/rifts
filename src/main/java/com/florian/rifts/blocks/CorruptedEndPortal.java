...
public class CorruptedEndPortal extends AbstractCorruptedBlock {
    public CorruptedEndPortal() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_END_PORTAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(END_PORTAL);
    }
}
