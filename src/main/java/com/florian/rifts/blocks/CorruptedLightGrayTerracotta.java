...
public class CorruptedLightGrayTerracotta extends AbstractCorruptedBlock {
    public CorruptedLightGrayTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_GRAY_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_GRAY_TERRACOTTA);
    }
}
