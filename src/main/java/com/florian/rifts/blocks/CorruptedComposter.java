...
public class CorruptedComposter extends AbstractCorruptedBlock {
    public CorruptedComposter() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COMPOSTER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COMPOSTER);
    }
}
