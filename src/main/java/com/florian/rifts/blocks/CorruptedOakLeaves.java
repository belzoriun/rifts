...
public class CorruptedOakLeaves extends AbstractCorruptedBlock {
    public CorruptedOakLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OAK_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OAK_LEAVES);
    }
}
