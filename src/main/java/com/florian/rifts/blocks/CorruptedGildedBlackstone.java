...
public class CorruptedGildedBlackstone extends AbstractCorruptedBlock {
    public CorruptedGildedBlackstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GILDED_BLACKSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GILDED_BLACKSTONE);
    }
}
