...
public class CorruptedLilyPad extends AbstractCorruptedBlock {
    public CorruptedLilyPad() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LILY_PAD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LILY_PAD);
    }
}
