...
public class CorruptedAnvil extends AbstractCorruptedBlock {
    public CorruptedAnvil() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ANVIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ANVIL);
    }
}
