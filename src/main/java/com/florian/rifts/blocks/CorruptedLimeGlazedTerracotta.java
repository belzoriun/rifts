...
public class CorruptedLimeGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedLimeGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_GLAZED_TERRACOTTA);
    }
}
