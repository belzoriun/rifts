...
public class CorruptedLimeConcretePowder extends AbstractCorruptedBlock {
    public CorruptedLimeConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_CONCRETE_POWDER);
    }
}
