...
public class CorruptedPoppy extends AbstractCorruptedBlock {
    public CorruptedPoppy() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POPPY;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POPPY);
    }
}
