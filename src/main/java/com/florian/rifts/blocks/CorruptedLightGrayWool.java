...
public class CorruptedLightGrayWool extends AbstractCorruptedBlock {
    public CorruptedLightGrayWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_GRAY_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_GRAY_WOOL);
    }
}
