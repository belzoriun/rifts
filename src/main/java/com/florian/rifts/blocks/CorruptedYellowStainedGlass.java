...
public class CorruptedYellowStainedGlass extends AbstractCorruptedBlock {
    public CorruptedYellowStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_YELLOW_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(YELLOW_STAINED_GLASS);
    }
}
