...
public class CorruptedMagentaStainedGlass extends AbstractCorruptedBlock {
    public CorruptedMagentaStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MAGENTA_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MAGENTA_STAINED_GLASS);
    }
}
