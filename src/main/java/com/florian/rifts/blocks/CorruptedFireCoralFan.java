...
public class CorruptedFireCoralFan extends AbstractCorruptedBlock {
    public CorruptedFireCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FIRE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FIRE_CORAL_FAN);
    }
}
