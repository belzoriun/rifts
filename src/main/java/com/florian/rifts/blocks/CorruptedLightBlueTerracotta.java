...
public class CorruptedLightBlueTerracotta extends AbstractCorruptedBlock {
    public CorruptedLightBlueTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_BLUE_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_BLUE_TERRACOTTA);
    }
}
