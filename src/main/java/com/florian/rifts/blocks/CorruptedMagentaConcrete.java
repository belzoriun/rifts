...
public class CorruptedMagentaConcrete extends AbstractCorruptedBlock {
    public CorruptedMagentaConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MAGENTA_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MAGENTA_CONCRETE);
    }
}
