...
public class CorruptedAmethystCluster extends AbstractCorruptedBlock {
    public CorruptedAmethystCluster() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_AMETHYST_CLUSTER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(AMETHYST_CLUSTER);
    }
}
