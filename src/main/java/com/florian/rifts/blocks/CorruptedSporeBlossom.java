...
public class CorruptedSporeBlossom extends AbstractCorruptedBlock {
    public CorruptedSporeBlossom() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPORE_BLOSSOM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPORE_BLOSSOM);
    }
}
