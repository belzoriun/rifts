...
public class CorruptedChiseledDeepslate extends AbstractCorruptedBlock {
    public CorruptedChiseledDeepslate() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHISELED_DEEPSLATE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHISELED_DEEPSLATE);
    }
}
