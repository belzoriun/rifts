...
public class CorruptedDeepslateCopperOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateCopperOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_COPPER_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_COPPER_ORE);
    }
}
