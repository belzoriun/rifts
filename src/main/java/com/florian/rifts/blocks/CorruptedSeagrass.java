...
public class CorruptedSeagrass extends AbstractCorruptedBlock {
    public CorruptedSeagrass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SEAGRASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SEAGRASS);
    }
}
