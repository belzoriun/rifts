...
public class CorruptedWarpedRoots extends AbstractCorruptedBlock {
    public CorruptedWarpedRoots() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_ROOTS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_ROOTS);
    }
}
