...
public class CorruptedPurpleConcretePowder extends AbstractCorruptedBlock {
    public CorruptedPurpleConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_CONCRETE_POWDER);
    }
}
