...
public class CorruptedQuartzBlock extends AbstractCorruptedBlock {
    public CorruptedQuartzBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_QUARTZ_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(QUARTZ_BLOCK);
    }
}
