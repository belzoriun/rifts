...
public class CorruptedSoulSoil extends AbstractCorruptedBlock {
    public CorruptedSoulSoil() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SOUL_SOIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SOUL_SOIL);
    }
}
