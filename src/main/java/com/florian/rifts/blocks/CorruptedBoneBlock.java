...
public class CorruptedBoneBlock extends AbstractCorruptedBlock {
    public CorruptedBoneBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BONE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BONE_BLOCK);
    }
}
