...
public class CorruptedCoalBlock extends AbstractCorruptedBlock {
    public CorruptedCoalBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COAL_BLOCK);
    }
}
