...
public class CorruptedJigsaw extends AbstractCorruptedBlock {
    public CorruptedJigsaw() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JIGSAW;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JIGSAW);
    }
}
