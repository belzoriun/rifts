...
public class CorruptedGrayConcrete extends AbstractCorruptedBlock {
    public CorruptedGrayConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_CONCRETE);
    }
}
