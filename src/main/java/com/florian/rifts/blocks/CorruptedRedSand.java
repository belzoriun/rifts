...
public class CorruptedRedSand extends AbstractCorruptedBlock {
    public CorruptedRedSand() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_SAND;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_SAND);
    }
}
