...
public class CorruptedBirchLeaves extends AbstractCorruptedBlock {
    public CorruptedBirchLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIRCH_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIRCH_LEAVES);
    }
}
