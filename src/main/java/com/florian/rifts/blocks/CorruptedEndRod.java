...
public class CorruptedEndRod extends AbstractCorruptedBlock {
    public CorruptedEndRod() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_END_ROD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(END_ROD);
    }
}
