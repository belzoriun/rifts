...
public class CorruptedPodzol extends AbstractCorruptedBlock {
    public CorruptedPodzol() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PODZOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PODZOL);
    }
}
