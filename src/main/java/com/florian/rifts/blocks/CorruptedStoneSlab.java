...
public class CorruptedStoneSlab extends AbstractCorruptedBlock {
    public CorruptedStoneSlab() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STONE_SLAB;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STONE_SLAB);
    }
}
