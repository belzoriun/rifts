...
public class CorruptedGrayConcretePowder extends AbstractCorruptedBlock {
    public CorruptedGrayConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_CONCRETE_POWDER);
    }
}
