...
public class CorruptedAcaciaLog extends AbstractCorruptedBlock {
    public CorruptedAcaciaLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ACACIA_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ACACIA_LOG);
    }
}
