...
public class CorruptedPolishedBasalt extends AbstractCorruptedBlock {
    public CorruptedPolishedBasalt() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_BASALT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_BASALT);
    }
}
