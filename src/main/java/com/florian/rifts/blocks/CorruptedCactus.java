...
public class CorruptedCactus extends AbstractCorruptedBlock {
    public CorruptedCactus() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CACTUS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CACTUS);
    }
}
