...
public class CorruptedBrainCoral extends AbstractCorruptedBlock {
    public CorruptedBrainCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BRAIN_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BRAIN_CORAL);
    }
}
