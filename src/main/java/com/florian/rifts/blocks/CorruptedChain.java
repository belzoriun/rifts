...
public class CorruptedChain extends AbstractCorruptedBlock {
    public CorruptedChain() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHAIN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHAIN);
    }
}
