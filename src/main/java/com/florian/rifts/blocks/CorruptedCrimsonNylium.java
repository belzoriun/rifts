...
public class CorruptedCrimsonNylium extends AbstractCorruptedBlock {
    public CorruptedCrimsonNylium() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRIMSON_NYLIUM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRIMSON_NYLIUM);
    }
}
