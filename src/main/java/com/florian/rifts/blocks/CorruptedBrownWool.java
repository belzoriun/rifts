...
public class CorruptedBrownWool extends AbstractCorruptedBlock {
    public CorruptedBrownWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_WOOL);
    }
}
