...
public class CorruptedWhiteConcretePowder extends AbstractCorruptedBlock {
    public CorruptedWhiteConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_CONCRETE_POWDER);
    }
}
