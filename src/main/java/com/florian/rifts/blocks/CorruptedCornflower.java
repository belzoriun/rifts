...
public class CorruptedCornflower extends AbstractCorruptedBlock {
    public CorruptedCornflower() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CORNFLOWER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CORNFLOWER);
    }
}
