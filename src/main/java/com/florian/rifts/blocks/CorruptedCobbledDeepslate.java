...
public class CorruptedCobbledDeepslate extends AbstractCorruptedBlock {
    public CorruptedCobbledDeepslate() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COBBLED_DEEPSLATE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COBBLED_DEEPSLATE);
    }
}
