...
public class CorruptedCalcite extends AbstractCorruptedBlock {
    public CorruptedCalcite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CALCITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CALCITE);
    }
}
