...
public class CorruptedHornCoralFan extends AbstractCorruptedBlock {
    public CorruptedHornCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HORN_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HORN_CORAL_FAN);
    }
}
