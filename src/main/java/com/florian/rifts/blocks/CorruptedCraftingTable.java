...
public class CorruptedCraftingTable extends AbstractCorruptedBlock {
    public CorruptedCraftingTable() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRAFTING_TABLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRAFTING_TABLE);
    }
}
