...
public class CorruptedChorusFlower extends AbstractCorruptedBlock {
    public CorruptedChorusFlower() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHORUS_FLOWER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHORUS_FLOWER);
    }
}
