...
public class CorruptedFarmland extends AbstractCorruptedBlock {
    public CorruptedFarmland() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FARMLAND;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FARMLAND);
    }
}
