...
public class CorruptedWhiteConcrete extends AbstractCorruptedBlock {
    public CorruptedWhiteConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_CONCRETE);
    }
}
