...
public class CorruptedFurnace extends AbstractCorruptedBlock {
    public CorruptedFurnace() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FURNACE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FURNACE);
    }
}
