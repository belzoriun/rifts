...
public class CorruptedBigDripleaf extends AbstractCorruptedBlock {
    public CorruptedBigDripleaf() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIG_DRIPLEAF;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIG_DRIPLEAF);
    }
}
