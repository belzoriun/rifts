...
public class CorruptedBrownConcrete extends AbstractCorruptedBlock {
    public CorruptedBrownConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_CONCRETE);
    }
}
