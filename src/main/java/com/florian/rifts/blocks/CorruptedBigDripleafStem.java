...
public class CorruptedBigDripleafStem extends AbstractCorruptedBlock {
    public CorruptedBigDripleafStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIG_DRIPLEAF_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIG_DRIPLEAF_STEM);
    }
}
