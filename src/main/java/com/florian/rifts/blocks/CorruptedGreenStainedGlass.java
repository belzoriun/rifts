...
public class CorruptedGreenStainedGlass extends AbstractCorruptedBlock {
    public CorruptedGreenStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_STAINED_GLASS);
    }
}
