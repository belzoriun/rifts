...
public class CorruptedLimeWool extends AbstractCorruptedBlock {
    public CorruptedLimeWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_WOOL);
    }
}
