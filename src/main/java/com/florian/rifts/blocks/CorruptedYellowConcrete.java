...
public class CorruptedYellowConcrete extends AbstractCorruptedBlock {
    public CorruptedYellowConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_YELLOW_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(YELLOW_CONCRETE);
    }
}
