...
public class CorruptedDarkOakLog extends AbstractCorruptedBlock {
    public CorruptedDarkOakLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DARK_OAK_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DARK_OAK_LOG);
    }
}
