...
public class CorruptedCaveVines extends AbstractCorruptedBlock {
    public CorruptedCaveVines() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CAVE_VINES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CAVE_VINES);
    }
}
