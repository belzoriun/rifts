...
public class CorruptedGreenTerracotta extends AbstractCorruptedBlock {
    public CorruptedGreenTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_TERRACOTTA);
    }
}
