...
public class CorruptedCyanConcretePowder extends AbstractCorruptedBlock {
    public CorruptedCyanConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_CONCRETE_POWDER);
    }
}
