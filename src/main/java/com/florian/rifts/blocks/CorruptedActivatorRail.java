...
public class CorruptedActivatorRail extends AbstractCorruptedBlock {
    public CorruptedActivatorRail() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ACTIVATOR_RAIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ACTIVATOR_RAIL);
    }
}
