...
public class CorruptedSugarCane extends AbstractCorruptedBlock {
    public CorruptedSugarCane() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SUGAR_CANE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SUGAR_CANE);
    }
}
