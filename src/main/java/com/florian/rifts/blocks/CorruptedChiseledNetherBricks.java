...
public class CorruptedChiseledNetherBricks extends AbstractCorruptedBlock {
    public CorruptedChiseledNetherBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHISELED_NETHER_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHISELED_NETHER_BRICKS);
    }
}
