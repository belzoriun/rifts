...
public class CorruptedBubbleCoral extends AbstractCorruptedBlock {
    public CorruptedBubbleCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BUBBLE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BUBBLE_CORAL);
    }
}
