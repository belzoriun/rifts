...
public class CorruptedTwistingVinesPlant extends AbstractCorruptedBlock {
    public CorruptedTwistingVinesPlant() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TWISTING_VINES_PLANT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TWISTING_VINES_PLANT);
    }
}
