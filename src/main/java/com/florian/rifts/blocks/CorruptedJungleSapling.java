...
public class CorruptedJungleSapling extends AbstractCorruptedBlock {
    public CorruptedJungleSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JUNGLE_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JUNGLE_SAPLING);
    }
}
