...
public class CorruptedPinkTulip extends AbstractCorruptedBlock {
    public CorruptedPinkTulip() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_TULIP;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_TULIP);
    }
}
