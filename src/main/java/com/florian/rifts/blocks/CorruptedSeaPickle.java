...
public class CorruptedSeaPickle extends AbstractCorruptedBlock {
    public CorruptedSeaPickle() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SEA_PICKLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SEA_PICKLE);
    }
}
