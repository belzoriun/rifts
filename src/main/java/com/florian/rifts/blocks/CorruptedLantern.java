...
public class CorruptedLantern extends AbstractCorruptedBlock {
    public CorruptedLantern() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LANTERN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LANTERN);
    }
}
