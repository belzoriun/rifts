...
public class CorruptedAcaciaLeaves extends AbstractCorruptedBlock {
    public CorruptedAcaciaLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ACACIA_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ACACIA_LEAVES);
    }
}
