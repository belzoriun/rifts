...
public class CorruptedStrippedWarpedStem extends AbstractCorruptedBlock {
    public CorruptedStrippedWarpedStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_WARPED_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_WARPED_STEM);
    }
}
