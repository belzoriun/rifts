...
public class CorruptedOxidizedCutCopper extends AbstractCorruptedBlock {
    public CorruptedOxidizedCutCopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OXIDIZED_CUT_COPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OXIDIZED_CUT_COPPER);
    }
}
