...
public class CorruptedOakLog extends AbstractCorruptedBlock {
    public CorruptedOakLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OAK_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OAK_LOG);
    }
}
