...
public class CorruptedNoteBlock extends AbstractCorruptedBlock {
    public CorruptedNoteBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NOTE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NOTE_BLOCK);
    }
}
