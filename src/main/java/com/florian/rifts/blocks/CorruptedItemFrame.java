...
public class CorruptedItemFrame extends AbstractCorruptedBlock {
    public CorruptedItemFrame() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ITEM_FRAME;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ITEM_FRAME);
    }
}
