...
public class CorruptedLever extends AbstractCorruptedBlock {
    public CorruptedLever() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LEVER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LEVER);
    }
}
