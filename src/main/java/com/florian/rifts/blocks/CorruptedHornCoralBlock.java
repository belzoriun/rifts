...
public class CorruptedHornCoralBlock extends AbstractCorruptedBlock {
    public CorruptedHornCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HORN_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HORN_CORAL_BLOCK);
    }
}
