...
public class CorruptedGranite extends AbstractCorruptedBlock {
    public CorruptedGranite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRANITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRANITE);
    }
}
