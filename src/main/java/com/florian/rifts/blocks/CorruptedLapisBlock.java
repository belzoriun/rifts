...
public class CorruptedLapisBlock extends AbstractCorruptedBlock {
    public CorruptedLapisBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LAPIS_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LAPIS_BLOCK);
    }
}
