...
public class CorruptedWetSponge extends AbstractCorruptedBlock {
    public CorruptedWetSponge() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WET_SPONGE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WET_SPONGE);
    }
}
