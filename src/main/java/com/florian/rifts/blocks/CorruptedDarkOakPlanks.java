...
public class CorruptedDarkOakPlanks extends AbstractCorruptedBlock {
    public CorruptedDarkOakPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DARK_OAK_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DARK_OAK_PLANKS);
    }
}
