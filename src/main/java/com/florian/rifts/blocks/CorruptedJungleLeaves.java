...
public class CorruptedJungleLeaves extends AbstractCorruptedBlock {
    public CorruptedJungleLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JUNGLE_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JUNGLE_LEAVES);
    }
}
