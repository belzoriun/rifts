...
public class CorruptedGreenConcretePowder extends AbstractCorruptedBlock {
    public CorruptedGreenConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_CONCRETE_POWDER);
    }
}
