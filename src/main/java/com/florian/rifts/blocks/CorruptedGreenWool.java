...
public class CorruptedGreenWool extends AbstractCorruptedBlock {
    public CorruptedGreenWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_WOOL);
    }
}
