...
public class CorruptedGrass extends AbstractCorruptedBlock {
    public CorruptedGrass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRASS);
    }
}
