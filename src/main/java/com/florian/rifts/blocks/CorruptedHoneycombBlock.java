...
public class CorruptedHoneycombBlock extends AbstractCorruptedBlock {
    public CorruptedHoneycombBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HONEYCOMB_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HONEYCOMB_BLOCK);
    }
}
