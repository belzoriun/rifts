...
public class CorruptedBuddingAmethyst extends AbstractCorruptedBlock {
    public CorruptedBuddingAmethyst() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BUDDING_AMETHYST;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BUDDING_AMETHYST);
    }
}
