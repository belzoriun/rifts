...
public class CorruptedSpruceLeaves extends AbstractCorruptedBlock {
    public CorruptedSpruceLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPRUCE_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPRUCE_LEAVES);
    }
}
