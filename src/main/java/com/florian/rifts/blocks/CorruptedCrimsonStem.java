...
public class CorruptedCrimsonStem extends AbstractCorruptedBlock {
    public CorruptedCrimsonStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRIMSON_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRIMSON_STEM);
    }
}
