...
public class CorruptedPurpleTerracotta extends AbstractCorruptedBlock {
    public CorruptedPurpleTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_TERRACOTTA);
    }
}
