...
public class CorruptedSpruceSapling extends AbstractCorruptedBlock {
    public CorruptedSpruceSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPRUCE_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPRUCE_SAPLING);
    }
}
