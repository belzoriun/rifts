...
public class CorruptedWhiteTerracotta extends AbstractCorruptedBlock {
    public CorruptedWhiteTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_TERRACOTTA);
    }
}
