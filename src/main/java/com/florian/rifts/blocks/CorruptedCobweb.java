...
public class CorruptedCobweb extends AbstractCorruptedBlock {
    public CorruptedCobweb() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COBWEB;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COBWEB);
    }
}
