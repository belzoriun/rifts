...
public class CorruptedPointedDripstone extends AbstractCorruptedBlock {
    public CorruptedPointedDripstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POINTED_DRIPSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POINTED_DRIPSTONE);
    }
}
