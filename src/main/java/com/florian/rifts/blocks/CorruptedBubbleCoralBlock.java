...
public class CorruptedBubbleCoralBlock extends AbstractCorruptedBlock {
    public CorruptedBubbleCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BUBBLE_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BUBBLE_CORAL_BLOCK);
    }
}
