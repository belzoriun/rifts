...
public class CorruptedDeadBubbleCoralFan extends AbstractCorruptedBlock {
    public CorruptedDeadBubbleCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_BUBBLE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_BUBBLE_CORAL_FAN);
    }
}
