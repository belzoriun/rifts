...
public class CorruptedGlass extends AbstractCorruptedBlock {
    public CorruptedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GLASS);
    }
}
