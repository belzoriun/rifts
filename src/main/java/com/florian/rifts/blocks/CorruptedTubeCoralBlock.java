...
public class CorruptedTubeCoralBlock extends AbstractCorruptedBlock {
    public CorruptedTubeCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TUBE_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TUBE_CORAL_BLOCK);
    }
}
