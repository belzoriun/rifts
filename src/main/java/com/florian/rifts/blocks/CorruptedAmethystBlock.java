...
public class CorruptedAmethystBlock extends AbstractCorruptedBlock {
    public CorruptedAmethystBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_AMETHYST_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(AMETHYST_BLOCK);
    }
}
