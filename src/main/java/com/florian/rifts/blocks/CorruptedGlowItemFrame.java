...
public class CorruptedGlowItemFrame extends AbstractCorruptedBlock {
    public CorruptedGlowItemFrame() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GLOW_ITEM_FRAME;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GLOW_ITEM_FRAME);
    }
}
