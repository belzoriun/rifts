...
public class CorruptedWarpedFungus extends AbstractCorruptedBlock {
    public CorruptedWarpedFungus() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_FUNGUS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_FUNGUS);
    }
}
