...
public class CorruptedGrayShulkerBox extends AbstractCorruptedBlock {
    public CorruptedGrayShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_SHULKER_BOX);
    }
}
