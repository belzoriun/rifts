...
public class CorruptedMagentaTerracotta extends AbstractCorruptedBlock {
    public CorruptedMagentaTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MAGENTA_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MAGENTA_TERRACOTTA);
    }
}
