...
public class CorruptedBrownConcretePowder extends AbstractCorruptedBlock {
    public CorruptedBrownConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_CONCRETE_POWDER);
    }
}
