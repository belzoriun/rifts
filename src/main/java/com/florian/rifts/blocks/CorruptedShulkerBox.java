...
public class CorruptedShulkerBox extends AbstractCorruptedBlock {
    public CorruptedShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SHULKER_BOX);
    }
}
