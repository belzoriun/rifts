...
public class CorruptedDeadBush extends AbstractCorruptedBlock {
    public CorruptedDeadBush() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_BUSH;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_BUSH);
    }
}
