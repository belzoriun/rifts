...
public class CorruptedMossyCobblestone extends AbstractCorruptedBlock {
    public CorruptedMossyCobblestone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MOSSY_COBBLESTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MOSSY_COBBLESTONE);
    }
}
