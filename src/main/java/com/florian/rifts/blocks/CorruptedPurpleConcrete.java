...
public class CorruptedPurpleConcrete extends AbstractCorruptedBlock {
    public CorruptedPurpleConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_CONCRETE);
    }
}
