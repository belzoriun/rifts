...
public class CorruptedDamagedAnvil extends AbstractCorruptedBlock {
    public CorruptedDamagedAnvil() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DAMAGED_ANVIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DAMAGED_ANVIL);
    }
}
