...
public class CorruptedRedStainedGlass extends AbstractCorruptedBlock {
    public CorruptedRedStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_STAINED_GLASS);
    }
}
