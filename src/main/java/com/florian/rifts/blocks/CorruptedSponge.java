...
public class CorruptedSponge extends AbstractCorruptedBlock {
    public CorruptedSponge() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPONGE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPONGE);
    }
}
