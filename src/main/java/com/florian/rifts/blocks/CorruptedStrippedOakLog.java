...
public class CorruptedStrippedOakLog extends AbstractCorruptedBlock {
    public CorruptedStrippedOakLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_OAK_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_OAK_LOG);
    }
}
