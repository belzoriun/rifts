...
public class CorruptedSpawner extends AbstractCorruptedBlock {
    public CorruptedSpawner() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPAWNER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPAWNER);
    }
}
