...
public class CorruptedWarpedNylium extends AbstractCorruptedBlock {
    public CorruptedWarpedNylium() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_NYLIUM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_NYLIUM);
    }
}
