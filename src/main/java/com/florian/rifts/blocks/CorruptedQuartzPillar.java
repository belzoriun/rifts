...
public class CorruptedQuartzPillar extends AbstractCorruptedBlock {
    public CorruptedQuartzPillar() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_QUARTZ_PILLAR;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(QUARTZ_PILLAR);
    }
}
