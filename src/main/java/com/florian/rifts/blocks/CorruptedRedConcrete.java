...
public class CorruptedRedConcrete extends AbstractCorruptedBlock {
    public CorruptedRedConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_CONCRETE);
    }
}
