...
public class CorruptedSmithingTable extends AbstractCorruptedBlock {
    public CorruptedSmithingTable() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMITHING_TABLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMITHING_TABLE);
    }
}
