...
public class CorruptedWarpedPlanks extends AbstractCorruptedBlock {
    public CorruptedWarpedPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_PLANKS);
    }
}
