...
public class CorruptedYellowTerracotta extends AbstractCorruptedBlock {
    public CorruptedYellowTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_YELLOW_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(YELLOW_TERRACOTTA);
    }
}
