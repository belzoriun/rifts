...
public class CorruptedStrippedAcaciaLog extends AbstractCorruptedBlock {
    public CorruptedStrippedAcaciaLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_ACACIA_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_ACACIA_LOG);
    }
}
