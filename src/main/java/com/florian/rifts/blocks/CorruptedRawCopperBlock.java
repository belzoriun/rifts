...
public class CorruptedRawCopperBlock extends AbstractCorruptedBlock {
    public CorruptedRawCopperBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RAW_COPPER_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RAW_COPPER_BLOCK);
    }
}
