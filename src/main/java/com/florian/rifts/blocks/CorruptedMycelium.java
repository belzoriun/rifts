...
public class CorruptedMycelium extends AbstractCorruptedBlock {
    public CorruptedMycelium() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MYCELIUM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MYCELIUM);
    }
}
