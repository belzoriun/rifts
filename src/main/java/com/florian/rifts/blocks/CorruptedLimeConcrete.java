...
public class CorruptedLimeConcrete extends AbstractCorruptedBlock {
    public CorruptedLimeConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_CONCRETE);
    }
}
