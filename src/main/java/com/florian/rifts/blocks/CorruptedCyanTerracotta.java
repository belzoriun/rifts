...
public class CorruptedCyanTerracotta extends AbstractCorruptedBlock {
    public CorruptedCyanTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_TERRACOTTA);
    }
}
