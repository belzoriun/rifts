...
public class CorruptedOrangeStainedGlass extends AbstractCorruptedBlock {
    public CorruptedOrangeStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_STAINED_GLASS);
    }
}
