...
public class CorruptedBrownMushroomBlock extends AbstractCorruptedBlock {
    public CorruptedBrownMushroomBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_MUSHROOM_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_MUSHROOM_BLOCK);
    }
}
