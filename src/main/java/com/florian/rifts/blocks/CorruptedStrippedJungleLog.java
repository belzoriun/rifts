...
public class CorruptedStrippedJungleLog extends AbstractCorruptedBlock {
    public CorruptedStrippedJungleLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_JUNGLE_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_JUNGLE_LOG);
    }
}
