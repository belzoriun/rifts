...
public class CorruptedDeadBubbleCoral extends AbstractCorruptedBlock {
    public CorruptedDeadBubbleCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_BUBBLE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_BUBBLE_CORAL);
    }
}
