...
public class CorruptedSoulLantern extends AbstractCorruptedBlock {
    public CorruptedSoulLantern() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SOUL_LANTERN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SOUL_LANTERN);
    }
}
