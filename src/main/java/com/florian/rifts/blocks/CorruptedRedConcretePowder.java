...
public class CorruptedRedConcretePowder extends AbstractCorruptedBlock {
    public CorruptedRedConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_CONCRETE_POWDER);
    }
}
