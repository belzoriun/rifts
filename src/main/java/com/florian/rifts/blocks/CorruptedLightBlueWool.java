...
public class CorruptedLightBlueWool extends AbstractCorruptedBlock {
    public CorruptedLightBlueWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_BLUE_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_BLUE_WOOL);
    }
}
