...
public class CorruptedWater extends AbstractCorruptedBlock {
    public CorruptedWater() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WATER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WATER);
    }
}
