...
public class CorruptedAttachedPumpkinStem extends AbstractCorruptedBlock {
    public CorruptedAttachedPumpkinStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ATTACHED_PUMPKIN_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ATTACHED_PUMPKIN_STEM);
    }
}
