...
public class CorruptedRawIronBlock extends AbstractCorruptedBlock {
    public CorruptedRawIronBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RAW_IRON_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RAW_IRON_BLOCK);
    }
}
