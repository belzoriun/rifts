...
public class CorruptedOrangeConcretePowder extends AbstractCorruptedBlock {
    public CorruptedOrangeConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_CONCRETE_POWDER);
    }
}
