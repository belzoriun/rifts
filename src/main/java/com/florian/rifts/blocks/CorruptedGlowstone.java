...
public class CorruptedGlowstone extends AbstractCorruptedBlock {
    public CorruptedGlowstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GLOWSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GLOWSTONE);
    }
}
