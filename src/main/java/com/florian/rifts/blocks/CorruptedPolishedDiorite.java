...
public class CorruptedPolishedDiorite extends AbstractCorruptedBlock {
    public CorruptedPolishedDiorite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_DIORITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_DIORITE);
    }
}
