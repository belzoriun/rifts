...
public class CorruptedRedGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedRedGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_GLAZED_TERRACOTTA);
    }
}
