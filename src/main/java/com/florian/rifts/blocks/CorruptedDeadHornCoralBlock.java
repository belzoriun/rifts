...
public class CorruptedDeadHornCoralBlock extends AbstractCorruptedBlock {
    public CorruptedDeadHornCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_HORN_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_HORN_CORAL_BLOCK);
    }
}
