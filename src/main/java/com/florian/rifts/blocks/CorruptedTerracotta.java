...
public class CorruptedTerracotta extends AbstractCorruptedBlock {
    public CorruptedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TERRACOTTA);
    }
}
