...
public class CorruptedLodestone extends AbstractCorruptedBlock {
    public CorruptedLodestone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LODESTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LODESTONE);
    }
}
