...
public class CorruptedHangingRoots extends AbstractCorruptedBlock {
    public CorruptedHangingRoots() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HANGING_ROOTS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HANGING_ROOTS);
    }
}
