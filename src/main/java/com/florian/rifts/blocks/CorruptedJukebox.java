...
public class CorruptedJukebox extends AbstractCorruptedBlock {
    public CorruptedJukebox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JUKEBOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JUKEBOX);
    }
}
