...
public class CorruptedMossyStoneBricks extends AbstractCorruptedBlock {
    public CorruptedMossyStoneBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MOSSY_STONE_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MOSSY_STONE_BRICKS);
    }
}
