...
public class CorruptedCrackedStoneBricks extends AbstractCorruptedBlock {
    public CorruptedCrackedStoneBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRACKED_STONE_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRACKED_STONE_BRICKS);
    }
}
