...
public class CorruptedBlueConcretePowder extends AbstractCorruptedBlock {
    public CorruptedBlueConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_CONCRETE_POWDER);
    }
}
