...
public class CorruptedCaveVinesPlant extends AbstractCorruptedBlock {
    public CorruptedCaveVinesPlant() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CAVE_VINES_PLANT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CAVE_VINES_PLANT);
    }
}
