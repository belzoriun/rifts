...
public class CorruptedAllium extends AbstractCorruptedBlock {
    public CorruptedAllium() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ALLIUM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ALLIUM);
    }
}
