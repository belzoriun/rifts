...
public class CorruptedSmallAmethystBud extends AbstractCorruptedBlock {
    public CorruptedSmallAmethystBud() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMALL_AMETHYST_BUD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMALL_AMETHYST_BUD);
    }
}
