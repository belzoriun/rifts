...
public class CorruptedBirchPlanks extends AbstractCorruptedBlock {
    public CorruptedBirchPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIRCH_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIRCH_PLANKS);
    }
}
