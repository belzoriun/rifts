...
public class CorruptedPinkConcrete extends AbstractCorruptedBlock {
    public CorruptedPinkConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_CONCRETE);
    }
}
