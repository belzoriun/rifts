...
public class CorruptedAzureBluet extends AbstractCorruptedBlock {
    public CorruptedAzureBluet() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_AZURE_BLUET;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(AZURE_BLUET);
    }
}
