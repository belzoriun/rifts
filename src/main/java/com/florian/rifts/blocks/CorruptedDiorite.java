...
public class CorruptedDiorite extends AbstractCorruptedBlock {
    public CorruptedDiorite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DIORITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DIORITE);
    }
}
