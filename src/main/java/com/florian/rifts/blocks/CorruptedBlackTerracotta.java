...
public class CorruptedBlackTerracotta extends AbstractCorruptedBlock {
    public CorruptedBlackTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_TERRACOTTA);
    }
}
