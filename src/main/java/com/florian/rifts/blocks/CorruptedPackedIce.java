...
public class CorruptedPackedIce extends AbstractCorruptedBlock {
    public CorruptedPackedIce() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PACKED_ICE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PACKED_ICE);
    }
}
