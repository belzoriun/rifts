...
public class CorruptedDeepslateTiles extends AbstractCorruptedBlock {
    public CorruptedDeepslateTiles() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_TILES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_TILES);
    }
}
