...
public class CorruptedGrayWool extends AbstractCorruptedBlock {
    public CorruptedGrayWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_WOOL);
    }
}
