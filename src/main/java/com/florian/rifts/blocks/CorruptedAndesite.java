...
public class CorruptedAndesite extends AbstractCorruptedBlock {
    public CorruptedAndesite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ANDESITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ANDESITE);
    }
}
