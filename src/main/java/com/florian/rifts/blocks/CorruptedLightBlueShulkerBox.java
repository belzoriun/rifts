...
public class CorruptedLightBlueShulkerBox extends AbstractCorruptedBlock {
    public CorruptedLightBlueShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHT_BLUE_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHT_BLUE_SHULKER_BOX);
    }
}
