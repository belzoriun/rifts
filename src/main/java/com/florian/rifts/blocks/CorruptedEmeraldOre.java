...
public class CorruptedEmeraldOre extends AbstractCorruptedBlock {
    public CorruptedEmeraldOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_EMERALD_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(EMERALD_ORE);
    }
}
