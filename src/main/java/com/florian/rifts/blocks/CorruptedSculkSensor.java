...
public class CorruptedSculkSensor extends AbstractCorruptedBlock {
    public CorruptedSculkSensor() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SCULK_SENSOR;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SCULK_SENSOR);
    }
}
