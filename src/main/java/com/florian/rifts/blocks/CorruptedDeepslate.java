...
public class CorruptedDeepslate extends AbstractCorruptedBlock {
    public CorruptedDeepslate() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE);
    }
}
