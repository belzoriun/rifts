...
public class CorruptedFloweringAzalea extends AbstractCorruptedBlock {
    public CorruptedFloweringAzalea() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FLOWERING_AZALEA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FLOWERING_AZALEA);
    }
}
