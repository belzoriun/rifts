...
public class CorruptedRedWool extends AbstractCorruptedBlock {
    public CorruptedRedWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_WOOL);
    }
}
