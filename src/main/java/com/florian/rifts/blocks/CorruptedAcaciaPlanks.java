...
public class CorruptedAcaciaPlanks extends AbstractCorruptedBlock {
    public CorruptedAcaciaPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ACACIA_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ACACIA_PLANKS);
    }
}
