...
public class CorruptedFletchingTable extends AbstractCorruptedBlock {
    public CorruptedFletchingTable() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FLETCHING_TABLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FLETCHING_TABLE);
    }
}
