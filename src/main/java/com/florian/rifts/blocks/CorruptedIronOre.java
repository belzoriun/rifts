...
public class CorruptedIronOre extends AbstractCorruptedBlock {
    public CorruptedIronOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_IRON_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(IRON_ORE);
    }
}
