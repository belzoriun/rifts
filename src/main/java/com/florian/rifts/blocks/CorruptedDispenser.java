...
public class CorruptedDispenser extends AbstractCorruptedBlock {
    public CorruptedDispenser() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DISPENSER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DISPENSER);
    }
}
