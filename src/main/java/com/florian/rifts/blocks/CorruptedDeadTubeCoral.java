...
public class CorruptedDeadTubeCoral extends AbstractCorruptedBlock {
    public CorruptedDeadTubeCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_TUBE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_TUBE_CORAL);
    }
}
