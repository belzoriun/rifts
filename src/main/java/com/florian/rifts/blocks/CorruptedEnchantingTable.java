...
public class CorruptedEnchantingTable extends AbstractCorruptedBlock {
    public CorruptedEnchantingTable() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ENCHANTING_TABLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ENCHANTING_TABLE);
    }
}
