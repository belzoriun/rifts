...
public class CorruptedTubeCoralFan extends AbstractCorruptedBlock {
    public CorruptedTubeCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TUBE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TUBE_CORAL_FAN);
    }
}
