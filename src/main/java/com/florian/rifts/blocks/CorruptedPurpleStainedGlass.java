...
public class CorruptedPurpleStainedGlass extends AbstractCorruptedBlock {
    public CorruptedPurpleStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_STAINED_GLASS);
    }
}
