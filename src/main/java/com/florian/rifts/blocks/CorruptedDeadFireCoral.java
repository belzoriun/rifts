...
public class CorruptedDeadFireCoral extends AbstractCorruptedBlock {
    public CorruptedDeadFireCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_FIRE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_FIRE_CORAL);
    }
}
