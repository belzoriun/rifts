...
public class CorruptedGreenConcrete extends AbstractCorruptedBlock {
    public CorruptedGreenConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_CONCRETE);
    }
}
