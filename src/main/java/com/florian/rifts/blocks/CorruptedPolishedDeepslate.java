...
public class CorruptedPolishedDeepslate extends AbstractCorruptedBlock {
    public CorruptedPolishedDeepslate() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_DEEPSLATE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_DEEPSLATE);
    }
}
