...
public class CorruptedEndStoneBricks extends AbstractCorruptedBlock {
    public CorruptedEndStoneBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_END_STONE_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(END_STONE_BRICKS);
    }
}
