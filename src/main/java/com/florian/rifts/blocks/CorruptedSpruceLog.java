...
public class CorruptedSpruceLog extends AbstractCorruptedBlock {
    public CorruptedSpruceLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SPRUCE_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SPRUCE_LOG);
    }
}
