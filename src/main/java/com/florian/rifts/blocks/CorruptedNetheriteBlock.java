...
public class CorruptedNetheriteBlock extends AbstractCorruptedBlock {
    public CorruptedNetheriteBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHERITE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHERITE_BLOCK);
    }
}
