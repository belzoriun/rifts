...
public class CorruptedGreenShulkerBox extends AbstractCorruptedBlock {
    public CorruptedGreenShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GREEN_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GREEN_SHULKER_BOX);
    }
}
