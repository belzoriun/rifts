...
public class CorruptedTwistingVines extends AbstractCorruptedBlock {
    public CorruptedTwistingVines() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TWISTING_VINES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TWISTING_VINES);
    }
}
