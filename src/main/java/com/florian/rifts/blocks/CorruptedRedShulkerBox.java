...
public class CorruptedRedShulkerBox extends AbstractCorruptedBlock {
    public CorruptedRedShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_SHULKER_BOX);
    }
}
