...
public class CorruptedHoneyBlock extends AbstractCorruptedBlock {
    public CorruptedHoneyBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HONEY_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HONEY_BLOCK);
    }
}
