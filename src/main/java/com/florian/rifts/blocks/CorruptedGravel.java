...
public class CorruptedGravel extends AbstractCorruptedBlock {
    public CorruptedGravel() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAVEL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAVEL);
    }
}
