...
public class CorruptedChainCommandBlock extends AbstractCorruptedBlock {
    public CorruptedChainCommandBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHAIN_COMMAND_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHAIN_COMMAND_BLOCK);
    }
}
