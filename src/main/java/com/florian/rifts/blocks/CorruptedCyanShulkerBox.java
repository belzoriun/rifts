...
public class CorruptedCyanShulkerBox extends AbstractCorruptedBlock {
    public CorruptedCyanShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_SHULKER_BOX);
    }
}
