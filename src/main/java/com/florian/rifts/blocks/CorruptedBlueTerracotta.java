...
public class CorruptedBlueTerracotta extends AbstractCorruptedBlock {
    public CorruptedBlueTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_TERRACOTTA);
    }
}
