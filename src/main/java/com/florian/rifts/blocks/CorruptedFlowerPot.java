...
public class CorruptedFlowerPot extends AbstractCorruptedBlock {
    public CorruptedFlowerPot() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FLOWER_POT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FLOWER_POT);
    }
}
