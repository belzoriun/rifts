...
public class CorruptedLadder extends AbstractCorruptedBlock {
    public CorruptedLadder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LADDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LADDER);
    }
}
