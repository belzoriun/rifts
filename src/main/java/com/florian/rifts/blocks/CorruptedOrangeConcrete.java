...
public class CorruptedOrangeConcrete extends AbstractCorruptedBlock {
    public CorruptedOrangeConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_CONCRETE);
    }
}
