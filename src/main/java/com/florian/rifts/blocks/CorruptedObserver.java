...
public class CorruptedObserver extends AbstractCorruptedBlock {
    public CorruptedObserver() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OBSERVER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OBSERVER);
    }
}
