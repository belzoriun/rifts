...
public class CorruptedMagentaWool extends AbstractCorruptedBlock {
    public CorruptedMagentaWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MAGENTA_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MAGENTA_WOOL);
    }
}
