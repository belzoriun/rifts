...
public class CorruptedMushroomStem extends AbstractCorruptedBlock {
    public CorruptedMushroomStem() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MUSHROOM_STEM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MUSHROOM_STEM);
    }
}
