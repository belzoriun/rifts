...
public class CorruptedLapisOre extends AbstractCorruptedBlock {
    public CorruptedLapisOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LAPIS_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LAPIS_ORE);
    }
}
