...
public class CorruptedDeadTubeCoralBlock extends AbstractCorruptedBlock {
    public CorruptedDeadTubeCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_TUBE_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_TUBE_CORAL_BLOCK);
    }
}
