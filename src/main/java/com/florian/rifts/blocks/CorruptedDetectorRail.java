...
public class CorruptedDetectorRail extends AbstractCorruptedBlock {
    public CorruptedDetectorRail() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DETECTOR_RAIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DETECTOR_RAIL);
    }
}
