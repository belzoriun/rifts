...
public class CorruptedBlackstone extends AbstractCorruptedBlock {
    public CorruptedBlackstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACKSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACKSTONE);
    }
}
