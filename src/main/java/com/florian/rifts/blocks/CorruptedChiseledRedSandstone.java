...
public class CorruptedChiseledRedSandstone extends AbstractCorruptedBlock {
    public CorruptedChiseledRedSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHISELED_RED_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHISELED_RED_SANDSTONE);
    }
}
