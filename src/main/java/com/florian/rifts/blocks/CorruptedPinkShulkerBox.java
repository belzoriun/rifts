...
public class CorruptedPinkShulkerBox extends AbstractCorruptedBlock {
    public CorruptedPinkShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_SHULKER_BOX);
    }
}
