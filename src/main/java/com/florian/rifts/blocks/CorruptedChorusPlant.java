...
public class CorruptedChorusPlant extends AbstractCorruptedBlock {
    public CorruptedChorusPlant() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHORUS_PLANT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHORUS_PLANT);
    }
}
