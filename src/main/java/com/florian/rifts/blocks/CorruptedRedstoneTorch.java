...
public class CorruptedRedstoneTorch extends AbstractCorruptedBlock {
    public CorruptedRedstoneTorch() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_REDSTONE_TORCH;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(REDSTONE_TORCH);
    }
}
