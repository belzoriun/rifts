...
public class CorruptedBlueGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedBlueGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_GLAZED_TERRACOTTA);
    }
}
