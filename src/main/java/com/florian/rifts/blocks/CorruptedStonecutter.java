...
public class CorruptedStonecutter extends AbstractCorruptedBlock {
    public CorruptedStonecutter() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STONECUTTER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STONECUTTER);
    }
}
