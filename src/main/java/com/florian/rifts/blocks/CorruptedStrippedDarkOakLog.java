...
public class CorruptedStrippedDarkOakLog extends AbstractCorruptedBlock {
    public CorruptedStrippedDarkOakLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_DARK_OAK_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_DARK_OAK_LOG);
    }
}
