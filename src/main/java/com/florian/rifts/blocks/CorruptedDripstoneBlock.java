...
public class CorruptedDripstoneBlock extends AbstractCorruptedBlock {
    public CorruptedDripstoneBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DRIPSTONE_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DRIPSTONE_BLOCK);
    }
}
