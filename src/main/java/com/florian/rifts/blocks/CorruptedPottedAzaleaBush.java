...
public class CorruptedPottedAzaleaBush extends AbstractCorruptedBlock {
    public CorruptedPottedAzaleaBush() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POTTED_AZALEA_BUSH;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POTTED_AZALEA_BUSH);
    }
}
