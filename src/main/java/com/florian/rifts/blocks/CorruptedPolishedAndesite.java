...
public class CorruptedPolishedAndesite extends AbstractCorruptedBlock {
    public CorruptedPolishedAndesite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_ANDESITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_ANDESITE);
    }
}
