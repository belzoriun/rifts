...
public class CorruptedCyanGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedCyanGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_GLAZED_TERRACOTTA);
    }
}
