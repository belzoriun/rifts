...
public class CorruptedChiseledStoneBricks extends AbstractCorruptedBlock {
    public CorruptedChiseledStoneBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHISELED_STONE_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHISELED_STONE_BRICKS);
    }
}
