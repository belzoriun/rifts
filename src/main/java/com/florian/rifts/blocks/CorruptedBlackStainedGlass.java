...
public class CorruptedBlackStainedGlass extends AbstractCorruptedBlock {
    public CorruptedBlackStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_STAINED_GLASS);
    }
}
