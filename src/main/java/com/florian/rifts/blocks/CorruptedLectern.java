...
public class CorruptedLectern extends AbstractCorruptedBlock {
    public CorruptedLectern() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LECTERN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LECTERN);
    }
}
