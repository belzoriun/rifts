...
public class CorruptedWhiteShulkerBox extends AbstractCorruptedBlock {
    public CorruptedWhiteShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_SHULKER_BOX);
    }
}
