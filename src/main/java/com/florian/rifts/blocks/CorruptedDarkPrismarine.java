...
public class CorruptedDarkPrismarine extends AbstractCorruptedBlock {
    public CorruptedDarkPrismarine() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DARK_PRISMARINE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DARK_PRISMARINE);
    }
}
