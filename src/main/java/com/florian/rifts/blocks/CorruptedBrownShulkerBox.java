...
public class CorruptedBrownShulkerBox extends AbstractCorruptedBlock {
    public CorruptedBrownShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_SHULKER_BOX);
    }
}
