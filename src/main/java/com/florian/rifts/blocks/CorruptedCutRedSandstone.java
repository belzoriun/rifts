...
public class CorruptedCutRedSandstone extends AbstractCorruptedBlock {
    public CorruptedCutRedSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CUT_RED_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CUT_RED_SANDSTONE);
    }
}
