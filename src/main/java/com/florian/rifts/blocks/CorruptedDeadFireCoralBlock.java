...
public class CorruptedDeadFireCoralBlock extends AbstractCorruptedBlock {
    public CorruptedDeadFireCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_FIRE_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_FIRE_CORAL_BLOCK);
    }
}
