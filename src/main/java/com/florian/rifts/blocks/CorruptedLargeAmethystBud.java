...
public class CorruptedLargeAmethystBud extends AbstractCorruptedBlock {
    public CorruptedLargeAmethystBud() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LARGE_AMETHYST_BUD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LARGE_AMETHYST_BUD);
    }
}
