...
public class CorruptedRedMushroom extends AbstractCorruptedBlock {
    public CorruptedRedMushroom() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_MUSHROOM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_MUSHROOM);
    }
}
