...
public class CorruptedBeacon extends AbstractCorruptedBlock {
    public CorruptedBeacon() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BEACON;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BEACON);
    }
}
