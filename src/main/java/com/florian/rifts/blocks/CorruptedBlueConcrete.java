...
public class CorruptedBlueConcrete extends AbstractCorruptedBlock {
    public CorruptedBlueConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_CONCRETE);
    }
}
