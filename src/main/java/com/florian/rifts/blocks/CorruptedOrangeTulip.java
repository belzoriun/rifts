...
public class CorruptedOrangeTulip extends AbstractCorruptedBlock {
    public CorruptedOrangeTulip() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ORANGE_TULIP;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ORANGE_TULIP);
    }
}
