...
public class CorruptedBarrel extends AbstractCorruptedBlock {
    public CorruptedBarrel() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BARREL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BARREL);
    }
}
