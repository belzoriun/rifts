...
public class CorruptedDeadHornCoralFan extends AbstractCorruptedBlock {
    public CorruptedDeadHornCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_HORN_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_HORN_CORAL_FAN);
    }
}
