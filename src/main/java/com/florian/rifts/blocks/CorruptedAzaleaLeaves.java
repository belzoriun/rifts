...
public class CorruptedAzaleaLeaves extends AbstractCorruptedBlock {
    public CorruptedAzaleaLeaves() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_AZALEA_LEAVES;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(AZALEA_LEAVES);
    }
}
