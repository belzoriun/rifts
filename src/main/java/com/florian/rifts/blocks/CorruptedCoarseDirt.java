...
public class CorruptedCoarseDirt extends AbstractCorruptedBlock {
    public CorruptedCoarseDirt() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COARSE_DIRT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COARSE_DIRT);
    }
}
