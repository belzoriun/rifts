...
public class CorruptedCampfire extends AbstractCorruptedBlock {
    public CorruptedCampfire() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CAMPFIRE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CAMPFIRE);
    }
}
