...
public class CorruptedCyanStainedGlass extends AbstractCorruptedBlock {
    public CorruptedCyanStainedGlass() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_STAINED_GLASS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_STAINED_GLASS);
    }
}
