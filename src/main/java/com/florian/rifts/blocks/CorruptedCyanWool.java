...
public class CorruptedCyanWool extends AbstractCorruptedBlock {
    public CorruptedCyanWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CYAN_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CYAN_WOOL);
    }
}
