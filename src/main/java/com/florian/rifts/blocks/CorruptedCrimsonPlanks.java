...
public class CorruptedCrimsonPlanks extends AbstractCorruptedBlock {
    public CorruptedCrimsonPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRIMSON_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRIMSON_PLANKS);
    }
}
