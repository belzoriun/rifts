...
public class CorruptedPumpkin extends AbstractCorruptedBlock {
    public CorruptedPumpkin() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PUMPKIN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PUMPKIN);
    }
}
