...
public class CorruptedTurtleEgg extends AbstractCorruptedBlock {
    public CorruptedTurtleEgg() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TURTLE_EGG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TURTLE_EGG);
    }
}
