...
public class CorruptedSoulCampfire extends AbstractCorruptedBlock {
    public CorruptedSoulCampfire() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SOUL_CAMPFIRE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SOUL_CAMPFIRE);
    }
}
