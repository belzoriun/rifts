...
public class CorruptedSmoothStoneSlab extends AbstractCorruptedBlock {
    public CorruptedSmoothStoneSlab() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMOOTH_STONE_SLAB;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMOOTH_STONE_SLAB);
    }
}
