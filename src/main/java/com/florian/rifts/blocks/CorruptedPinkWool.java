...
public class CorruptedPinkWool extends AbstractCorruptedBlock {
    public CorruptedPinkWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_WOOL);
    }
}
