...
public class CorruptedNetherBricks extends AbstractCorruptedBlock {
    public CorruptedNetherBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHER_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHER_BRICKS);
    }
}
