...
public class CorruptedDeepslateCoalOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateCoalOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_COAL_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_COAL_ORE);
    }
}
