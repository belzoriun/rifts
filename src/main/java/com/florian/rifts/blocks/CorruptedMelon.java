...
public class CorruptedMelon extends AbstractCorruptedBlock {
    public CorruptedMelon() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_MELON;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(MELON);
    }
}
