...
public class CorruptedBrownMushroom extends AbstractCorruptedBlock {
    public CorruptedBrownMushroom() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BROWN_MUSHROOM;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BROWN_MUSHROOM);
    }
}
