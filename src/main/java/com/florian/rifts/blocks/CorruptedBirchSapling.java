...
public class CorruptedBirchSapling extends AbstractCorruptedBlock {
    public CorruptedBirchSapling() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIRCH_SAPLING;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIRCH_SAPLING);
    }
}
