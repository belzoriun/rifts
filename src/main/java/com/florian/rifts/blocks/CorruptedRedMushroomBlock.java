...
public class CorruptedRedMushroomBlock extends AbstractCorruptedBlock {
    public CorruptedRedMushroomBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_MUSHROOM_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_MUSHROOM_BLOCK);
    }
}
