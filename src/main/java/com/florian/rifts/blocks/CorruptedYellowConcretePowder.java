...
public class CorruptedYellowConcretePowder extends AbstractCorruptedBlock {
    public CorruptedYellowConcretePowder() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_YELLOW_CONCRETE_POWDER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(YELLOW_CONCRETE_POWDER);
    }
}
