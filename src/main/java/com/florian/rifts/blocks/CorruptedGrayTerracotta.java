...
public class CorruptedGrayTerracotta extends AbstractCorruptedBlock {
    public CorruptedGrayTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_GRAY_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(GRAY_TERRACOTTA);
    }
}
