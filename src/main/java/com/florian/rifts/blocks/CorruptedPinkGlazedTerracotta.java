...
public class CorruptedPinkGlazedTerracotta extends AbstractCorruptedBlock {
    public CorruptedPinkGlazedTerracotta() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PINK_GLAZED_TERRACOTTA;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PINK_GLAZED_TERRACOTTA);
    }
}
