...
public class CorruptedWhiteTulip extends AbstractCorruptedBlock {
    public CorruptedWhiteTulip() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_TULIP;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_TULIP);
    }
}
