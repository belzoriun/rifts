...
public class CorruptedIronBlock extends AbstractCorruptedBlock {
    public CorruptedIronBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_IRON_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(IRON_BLOCK);
    }
}
