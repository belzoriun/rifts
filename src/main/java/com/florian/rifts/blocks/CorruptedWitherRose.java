...
public class CorruptedWitherRose extends AbstractCorruptedBlock {
    public CorruptedWitherRose() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WITHER_ROSE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WITHER_ROSE);
    }
}
