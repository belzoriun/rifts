...
public class CorruptedNetherWartBlock extends AbstractCorruptedBlock {
    public CorruptedNetherWartBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHER_WART_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHER_WART_BLOCK);
    }
}
