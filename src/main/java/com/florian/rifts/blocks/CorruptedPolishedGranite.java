...
public class CorruptedPolishedGranite extends AbstractCorruptedBlock {
    public CorruptedPolishedGranite() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_GRANITE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_GRANITE);
    }
}
