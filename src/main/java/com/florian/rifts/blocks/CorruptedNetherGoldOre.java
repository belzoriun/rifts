...
public class CorruptedNetherGoldOre extends AbstractCorruptedBlock {
    public CorruptedNetherGoldOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHER_GOLD_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHER_GOLD_ORE);
    }
}
