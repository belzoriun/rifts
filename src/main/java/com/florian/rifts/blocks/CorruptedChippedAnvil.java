...
public class CorruptedChippedAnvil extends AbstractCorruptedBlock {
    public CorruptedChippedAnvil() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHIPPED_ANVIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHIPPED_ANVIL);
    }
}
