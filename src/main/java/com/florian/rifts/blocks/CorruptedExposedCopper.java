...
public class CorruptedExposedCopper extends AbstractCorruptedBlock {
    public CorruptedExposedCopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_EXPOSED_COPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(EXPOSED_COPPER);
    }
}
