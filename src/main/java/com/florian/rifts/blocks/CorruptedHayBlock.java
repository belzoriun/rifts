...
public class CorruptedHayBlock extends AbstractCorruptedBlock {
    public CorruptedHayBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_HAY_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(HAY_BLOCK);
    }
}
