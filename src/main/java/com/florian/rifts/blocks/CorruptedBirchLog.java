...
public class CorruptedBirchLog extends AbstractCorruptedBlock {
    public CorruptedBirchLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BIRCH_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BIRCH_LOG);
    }
}
