...
public class CorruptedPurpleShulkerBox extends AbstractCorruptedBlock {
    public CorruptedPurpleShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPLE_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPLE_SHULKER_BOX);
    }
}
