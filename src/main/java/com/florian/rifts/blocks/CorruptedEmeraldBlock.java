...
public class CorruptedEmeraldBlock extends AbstractCorruptedBlock {
    public CorruptedEmeraldBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_EMERALD_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(EMERALD_BLOCK);
    }
}
