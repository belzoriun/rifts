...
public class CorruptedRawGoldBlock extends AbstractCorruptedBlock {
    public CorruptedRawGoldBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RAW_GOLD_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RAW_GOLD_BLOCK);
    }
}
