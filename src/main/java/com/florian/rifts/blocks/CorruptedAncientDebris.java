...
public class CorruptedAncientDebris extends AbstractCorruptedBlock {
    public CorruptedAncientDebris() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ANCIENT_DEBRIS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ANCIENT_DEBRIS);
    }
}
