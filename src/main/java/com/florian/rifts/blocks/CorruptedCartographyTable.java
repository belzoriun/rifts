...
public class CorruptedCartographyTable extends AbstractCorruptedBlock {
    public CorruptedCartographyTable() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CARTOGRAPHY_TABLE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CARTOGRAPHY_TABLE);
    }
}
