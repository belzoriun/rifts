...
public class CorruptedCobblestone extends AbstractCorruptedBlock {
    public CorruptedCobblestone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COBBLESTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COBBLESTONE);
    }
}
