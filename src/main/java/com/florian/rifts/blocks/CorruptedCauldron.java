...
public class CorruptedCauldron extends AbstractCorruptedBlock {
    public CorruptedCauldron() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CAULDRON;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CAULDRON);
    }
}
