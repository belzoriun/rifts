...
public class CorruptedDeepslateDiamondOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateDiamondOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_DIAMOND_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_DIAMOND_ORE);
    }
}
