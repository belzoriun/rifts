...
public class CorruptedDeepslateIronOre extends AbstractCorruptedBlock {
    public CorruptedDeepslateIronOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEEPSLATE_IRON_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEEPSLATE_IRON_ORE);
    }
}
