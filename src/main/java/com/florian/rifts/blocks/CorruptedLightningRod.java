...
public class CorruptedLightningRod extends AbstractCorruptedBlock {
    public CorruptedLightningRod() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIGHTNING_ROD;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIGHTNING_ROD);
    }
}
