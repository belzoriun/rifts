...
public class CorruptedConduit extends AbstractCorruptedBlock {
    public CorruptedConduit() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CONDUIT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CONDUIT);
    }
}
