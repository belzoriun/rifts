...
public class CorruptedSoulSand extends AbstractCorruptedBlock {
    public CorruptedSoulSand() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SOUL_SAND;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SOUL_SAND);
    }
}
