...
public class CorruptedStoneBricks extends AbstractCorruptedBlock {
    public CorruptedStoneBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STONE_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STONE_BRICKS);
    }
}
