...
public class CorruptedSmoothStone extends AbstractCorruptedBlock {
    public CorruptedSmoothStone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMOOTH_STONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMOOTH_STONE);
    }
}
