...
public class CorruptedBrewingStand extends AbstractCorruptedBlock {
    public CorruptedBrewingStand() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BREWING_STAND;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BREWING_STAND);
    }
}
