...
public class CorruptedPoweredRail extends AbstractCorruptedBlock {
    public CorruptedPoweredRail() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POWERED_RAIL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POWERED_RAIL);
    }
}
