...
public class CorruptedDeadBrainCoral extends AbstractCorruptedBlock {
    public CorruptedDeadBrainCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_BRAIN_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_BRAIN_CORAL);
    }
}
