...
public class CorruptedBlackConcrete extends AbstractCorruptedBlock {
    public CorruptedBlackConcrete() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_CONCRETE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_CONCRETE);
    }
}
