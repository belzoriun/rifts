...
public class CorruptedStrippedSpruceLog extends AbstractCorruptedBlock {
    public CorruptedStrippedSpruceLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_STRIPPED_SPRUCE_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(STRIPPED_SPRUCE_LOG);
    }
}
