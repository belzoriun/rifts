...
public class CorruptedEndStone extends AbstractCorruptedBlock {
    public CorruptedEndStone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_END_STONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(END_STONE);
    }
}
