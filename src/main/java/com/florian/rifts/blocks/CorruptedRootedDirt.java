...
public class CorruptedRootedDirt extends AbstractCorruptedBlock {
    public CorruptedRootedDirt() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_ROOTED_DIRT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(ROOTED_DIRT);
    }
}
