...
public class CorruptedBlackShulkerBox extends AbstractCorruptedBlock {
    public CorruptedBlackShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLACK_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLACK_SHULKER_BOX);
    }
}
