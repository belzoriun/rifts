...
public class CorruptedWarpedWartBlock extends AbstractCorruptedBlock {
    public CorruptedWarpedWartBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WARPED_WART_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WARPED_WART_BLOCK);
    }
}
