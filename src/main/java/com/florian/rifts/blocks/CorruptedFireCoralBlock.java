...
public class CorruptedFireCoralBlock extends AbstractCorruptedBlock {
    public CorruptedFireCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FIRE_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FIRE_CORAL_BLOCK);
    }
}
