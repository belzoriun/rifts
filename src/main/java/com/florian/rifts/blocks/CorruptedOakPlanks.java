...
public class CorruptedOakPlanks extends AbstractCorruptedBlock {
    public CorruptedOakPlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OAK_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OAK_PLANKS);
    }
}
