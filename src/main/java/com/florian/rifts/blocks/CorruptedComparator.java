...
public class CorruptedComparator extends AbstractCorruptedBlock {
    public CorruptedComparator() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COMPARATOR;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COMPARATOR);
    }
}
