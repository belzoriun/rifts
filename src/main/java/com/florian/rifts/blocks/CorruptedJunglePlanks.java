...
public class CorruptedJunglePlanks extends AbstractCorruptedBlock {
    public CorruptedJunglePlanks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JUNGLE_PLANKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JUNGLE_PLANKS);
    }
}
