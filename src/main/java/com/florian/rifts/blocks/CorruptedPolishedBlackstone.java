...
public class CorruptedPolishedBlackstone extends AbstractCorruptedBlock {
    public CorruptedPolishedBlackstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_POLISHED_BLACKSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(POLISHED_BLACKSTONE);
    }
}
