...
public class CorruptedTubeCoral extends AbstractCorruptedBlock {
    public CorruptedTubeCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_TUBE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(TUBE_CORAL);
    }
}
