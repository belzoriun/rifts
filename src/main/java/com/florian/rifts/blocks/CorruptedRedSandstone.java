...
public class CorruptedRedSandstone extends AbstractCorruptedBlock {
    public CorruptedRedSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_SANDSTONE);
    }
}
