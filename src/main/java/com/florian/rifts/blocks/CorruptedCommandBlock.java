...
public class CorruptedCommandBlock extends AbstractCorruptedBlock {
    public CorruptedCommandBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_COMMAND_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(COMMAND_BLOCK);
    }
}
