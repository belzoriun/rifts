...
public class CorruptedCrimsonRoots extends AbstractCorruptedBlock {
    public CorruptedCrimsonRoots() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRIMSON_ROOTS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRIMSON_ROOTS);
    }
}
