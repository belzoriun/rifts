...
public class CorruptedLimeShulkerBox extends AbstractCorruptedBlock {
    public CorruptedLimeShulkerBox() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_LIME_SHULKER_BOX;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(LIME_SHULKER_BOX);
    }
}
