...
public class CorruptedOxeyeDaisy extends AbstractCorruptedBlock {
    public CorruptedOxeyeDaisy() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OXEYE_DAISY;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OXEYE_DAISY);
    }
}
