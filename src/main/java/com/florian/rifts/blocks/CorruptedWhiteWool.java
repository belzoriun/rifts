...
public class CorruptedWhiteWool extends AbstractCorruptedBlock {
    public CorruptedWhiteWool() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WHITE_WOOL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WHITE_WOOL);
    }
}
