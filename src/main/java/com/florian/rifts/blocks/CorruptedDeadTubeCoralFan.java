...
public class CorruptedDeadTubeCoralFan extends AbstractCorruptedBlock {
    public CorruptedDeadTubeCoralFan() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DEAD_TUBE_CORAL_FAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DEAD_TUBE_CORAL_FAN);
    }
}
