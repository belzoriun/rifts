...
public class CorruptedChiseledSandstone extends AbstractCorruptedBlock {
    public CorruptedChiseledSandstone() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CHISELED_SANDSTONE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CHISELED_SANDSTONE);
    }
}
