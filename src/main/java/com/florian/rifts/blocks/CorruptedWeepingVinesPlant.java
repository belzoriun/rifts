...
public class CorruptedWeepingVinesPlant extends AbstractCorruptedBlock {
    public CorruptedWeepingVinesPlant() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WEEPING_VINES_PLANT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WEEPING_VINES_PLANT);
    }
}
