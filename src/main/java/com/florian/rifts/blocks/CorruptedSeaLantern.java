...
public class CorruptedSeaLantern extends AbstractCorruptedBlock {
    public CorruptedSeaLantern() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SEA_LANTERN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SEA_LANTERN);
    }
}
