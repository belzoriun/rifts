...
public class CorruptedBlueOrchid extends AbstractCorruptedBlock {
    public CorruptedBlueOrchid() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BLUE_ORCHID;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BLUE_ORCHID);
    }
}
