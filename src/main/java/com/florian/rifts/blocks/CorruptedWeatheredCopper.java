...
public class CorruptedWeatheredCopper extends AbstractCorruptedBlock {
    public CorruptedWeatheredCopper() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_WEATHERED_COPPER;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(WEATHERED_COPPER);
    }
}
