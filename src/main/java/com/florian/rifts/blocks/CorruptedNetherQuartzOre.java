...
public class CorruptedNetherQuartzOre extends AbstractCorruptedBlock {
    public CorruptedNetherQuartzOre() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHER_QUARTZ_ORE;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHER_QUARTZ_ORE);
    }
}
