...
public class CorruptedCarvedPumpkin extends AbstractCorruptedBlock {
    public CorruptedCarvedPumpkin() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CARVED_PUMPKIN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CARVED_PUMPKIN);
    }
}
