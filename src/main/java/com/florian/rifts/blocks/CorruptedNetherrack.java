...
public class CorruptedNetherrack extends AbstractCorruptedBlock {
    public CorruptedNetherrack() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHERRACK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHERRACK);
    }
}
