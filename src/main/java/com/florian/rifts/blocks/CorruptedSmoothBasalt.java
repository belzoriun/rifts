...
public class CorruptedSmoothBasalt extends AbstractCorruptedBlock {
    public CorruptedSmoothBasalt() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_SMOOTH_BASALT;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(SMOOTH_BASALT);
    }
}
