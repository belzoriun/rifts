...
public class CorruptedNetherSprouts extends AbstractCorruptedBlock {
    public CorruptedNetherSprouts() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_NETHER_SPROUTS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(NETHER_SPROUTS);
    }
}
