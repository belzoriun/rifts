...
public class CorruptedBricks extends AbstractCorruptedBlock {
    public CorruptedBricks() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BRICKS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BRICKS);
    }
}
