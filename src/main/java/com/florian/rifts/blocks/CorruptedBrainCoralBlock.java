...
public class CorruptedBrainCoralBlock extends AbstractCorruptedBlock {
    public CorruptedBrainCoralBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BRAIN_CORAL_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BRAIN_CORAL_BLOCK);
    }
}
