...
public class CorruptedFireCoral extends AbstractCorruptedBlock {
    public CorruptedFireCoral() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_FIRE_CORAL;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(FIRE_CORAL);
    }
}
