...
public class CorruptedDandelion extends AbstractCorruptedBlock {
    public CorruptedDandelion() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_DANDELION;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(DANDELION);
    }
}
