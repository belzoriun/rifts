...
public class CorruptedObsidian extends AbstractCorruptedBlock {
    public CorruptedObsidian() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_OBSIDIAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(OBSIDIAN);
    }
}
