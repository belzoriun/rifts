...
public class CorruptedCryingObsidian extends AbstractCorruptedBlock {
    public CorruptedCryingObsidian() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRYING_OBSIDIAN;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRYING_OBSIDIAN);
    }
}
