...
public class CorruptedPiston extends AbstractCorruptedBlock {
    public CorruptedPiston() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PISTON;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PISTON);
    }
}
