...
public class CorruptedBookshelf extends AbstractCorruptedBlock {
    public CorruptedBookshelf() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_BOOKSHELF;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BOOKSHELF);
    }
}
