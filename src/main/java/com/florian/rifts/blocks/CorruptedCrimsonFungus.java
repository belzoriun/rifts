...
public class CorruptedCrimsonFungus extends AbstractCorruptedBlock {
    public CorruptedCrimsonFungus() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_CRIMSON_FUNGUS;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(CRIMSON_FUNGUS);
    }
}
