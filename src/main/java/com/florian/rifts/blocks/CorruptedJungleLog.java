...
public class CorruptedJungleLog extends AbstractCorruptedBlock {
    public CorruptedJungleLog() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_JUNGLE_LOG;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(JUNGLE_LOG);
    }
}
