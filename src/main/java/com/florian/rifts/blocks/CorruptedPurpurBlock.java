...
public class CorruptedPurpurBlock extends AbstractCorruptedBlock {
    public CorruptedPurpurBlock() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_PURPUR_BLOCK;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(PURPUR_BLOCK);
    }
}
