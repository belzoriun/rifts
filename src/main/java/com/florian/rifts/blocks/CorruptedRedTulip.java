...
public class CorruptedRedTulip extends AbstractCorruptedBlock {
    public CorruptedRedTulip() {
    ...
    public Block backwardReplacementMap(Block old) {
        return Rifts.Blocks.BURNED_RED_TULIP;
    }

    @Override
    public boolean doesReplace(World world, BlockPos pos) {
        return world.getBlockState(pos).isOf(RED_TULIP);
    }
}
